...
mongoose.connect(process.env.DATABASE_URL || "mongodb+srv://shashank:shashank123@cluster2.ior0t7g.mongodb.net/test").then(() => {
...
app.get("/", (req, res) => {
    res.send("InstaClone Backend By SHASHANK H M")
})
